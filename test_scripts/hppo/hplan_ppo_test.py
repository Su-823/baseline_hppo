...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default="MazeRooms-3by3-Locked-v0")#"MazeRooms-2by2-TwoKeysSmall"
    ...
    parser.add_argument("--seed", type=int, default=1)      # this seed is actually... trial; randomness in agent trials
    ...
    # train_env = utils.make_env_fn('MiniGrid-SimpleDoorKey-Min5-Max10-View3', 
                                #    render_mode="rgb_array", 
                                #    frame_stack = 1)
    # train_env = utils.WrapEnv(train_env)
    ...
    # eval_env = utils.make_env_fn('MiniGrid-SimpleDoorKey-Min5-Max10-View3', 
                                #    render_mode="rgb_array", 
                                #    frame_stack = 1)
    # eval_env = utils.WrapEnv(eval_env)
    ...
    eval_callback = CustumEvalCallback(eval_env, eval_parl_task=parl_task,
